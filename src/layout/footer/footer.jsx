    ...
    <Box py={'40px'} bgcolor={theme.palette.grey.main}>
        <Container maxWidth="xs">
            <Stack direction={{xs: 'column', md: 'row'}}  gap={{xs: '24px', md: '64px'}}>
                ...
                <Ul>
                    <Li>
                        <Typography mb={{xs: '16px', md: '24px'}} fontSize={{ xs: '14px', md: '18px'}} variant='h2'>Личный кабинет</Typography>
                        <Typography variant='body2'>Ковры</Typography>
                    </Li>
                    <Li>
                        <Typography variant='body2'>Коврики</Typography>
                ...
                <Ul>
                    <Li>
                        <Typography mb={{xs: '16px', md: '24px'}} fontSize={{ xs: '14px', md: '18px'}} variant='h2'>Центр поддержки</Typography>
                        <Typography variant='body2'>Ковры</Typography>
                    </Li>
                    <Li>
                        <Typography variant='body2'>Коврики</Typography>
                ...
                <Ul>
                    <Li>
                        <Typography mb={{xs: '16px', md: '24px'}} fontSize={{ xs: '14px', md: '18px'}} variant='h2'>Помощь и контакты</Typography>
                ...
                <Ul>
                    <Li>
                        <Typography mb={{xs: '16px', md: '24px'}} fontSize={{ xs: '14px', md: '18px'}} variant='h2'>Рассылка</Typography>
                    </Li>
                    <Li>
